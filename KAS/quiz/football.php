...
mysqli_query($mysqli, "INSERT INTO leaderboard (name, email, username, category) VALUE('$sess_name','$sess_email','$user_name','$cat_name')");
 }	
...
<div class="quizcat-top-football"></div>
